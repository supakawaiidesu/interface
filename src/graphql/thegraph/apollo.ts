...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  ...
  [SupportedChainId.FANTOM_TESTNET]: 'https://api.thegraph.com/subgraphs/name/ianlapham/optimism-post-regenesis',
  ...
  [SupportedChainId.FANTOM]: 'https://api.thegraph.com/subgraphs/name/jesse-sawa/uniswap-celo',
