/*
 * SupportedChainId must be defined inline, without using @unidexexchange/sdk-core, so that its members are their own types
 ...
 *
 * Because this is not explicitly derived from @unidexexchange/sdk-core, there is a unit test to enforce conformance.
 */
