import { Currency, CurrencyAmount, Price, Token, TradeType } from '@unidexexchange/sdk-core'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.FANTOM_TESTNET]: CurrencyAmount.fromRawAmount(USDC_MAINNET, 10_000e6),
